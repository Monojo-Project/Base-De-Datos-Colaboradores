...
#include <QKeyEvent> // <-- Añadido para gestionar los eventos de teclado
#include <QSettings>
...
public:
    LyndsCorpApp() {
        setWindowTitle("Lynds Corp. - Base de Datos de Contribuidores");
        resize(980, 750);
...
private:
    ...
    void loadContributors() {
        QString rawPath = "~/CONTRIBUIDORES.md";
